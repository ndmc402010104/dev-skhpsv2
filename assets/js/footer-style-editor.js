...
(function () {
  ...
  var FIELDS = [
    ["Footer 背景", "[data-skhps-footer]", "background", "#ffffff", "footer 背景色"],
    ["Footer 文字顏色", "[data-skhps-footer]", "color", "#64748b", "footer 主要文字顏色"],
    ["Footer 上框線", "[data-skhps-footer]", "border-top", "1px solid #cbd5e1", "footer 與頁面內容之間的分隔線"],
    ["Footer 內距", "[data-skhps-footer]", "padding", "12px 16px", "footer 內距"],
    ["Footer 字體大小", "[data-skhps-footer]", "font-size", "13px", "footer 字體大小"],
    ["Footer 對齊", "[data-skhps-footer]", "text-align", "center", "footer 文字對齊"]
  ];
  ...
  function render(root, values) {
    root.innerHTML = [
      "<section data-css-setting-editor data-css-setting-core='on' data-css-setting-component='" + COMPONENT + "' data-css-setting-tab-key='" + TAB_KEY + "'>",
      "<h3>Footer 欄位</h3>",
