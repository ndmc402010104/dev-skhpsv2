...
(function () {
  ...
  function ensureStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = [
      "html.runtime-state-closed,html.runtime-state-full{--skhps-footer-dock-bottom:var(--skhps-footer-height,48px);--skhps-footer-viewport-top:0px;--skhps-runtime-summary-height:0px;--skhps-runtime-full-height:0px;--skhps-runtime-tail-height:0px;--skhps-runtime-visible-height:0px;--skhps-runtime-tail-spacer:0px;--skhps-runtime-docked-reserve-height:0px}",
      ...
      "html.runtime-state-full[data-skhps-runtime-docked='true'] .skhps-runtime-tail{height:var(--skhps-runtime-tail-height,0px)!important;margin-top:0!important;min-height:var(--skhps-runtime-tail-height,0px)!important;max-height:none!important;overflow:hidden!important}",
      ...
      "html.runtime-state-full[data-skhps-runtime-docked='true'][data-skhps-runtime-fixed-mode='peek'] .skhps-runtime-panel{position:fixed!important;left:0!important;right:0!important;bottom:calc(var(--skhps-footer-dock-bottom,var(--skhps-footer-height,48px)) + var(--skhps-runtime-summary-height,0px) - var(--skhps-runtime-full-height,0px))!important;height:auto!important;max-height:none!important;opacity:1!important;visibility:visible!important;pointer-events:auto!important;overflow:visible!important;z-index:2147482980!important;box-shadow:0 -14px 34px rgba(15,23,42,.16)!important}",
      "html.runtime-state-full[data-skhps-runtime-docked='true']:not([data-skhps-runtime-fixed-mode='peek']) .skhps-runtime-panel{position:fixed!important;left:0!important;right:0!important;top:var(--skhps-visual-viewport-offset-top,0px)!important;bottom:var(--skhps-footer-dock-bottom,var(--skhps-footer-height,48px))!important;height:auto!important;max-height:calc(var(--skhps-visual-viewport-height,100dvh) - var(--skhps-footer-dock-bottom,var(--skhps-footer-height,48px)))!important;opacity:1!important;visibility:visible!important;pointer-events:auto!important;overflow-x:hidden!important;overflow-y:auto!important;overscroll-behavior:contain!important;-webkit-overflow-scrolling:touch!important;z-index:2147482980!important;box-shadow:0 -14px 34px rgba(15,23,42,.16)!important}",
